...
function color(x) {
  ...
  if (shade) {
    ...
    let [, name2, opacity] = /^([^\/]+)(\/\d+)?$/.exec(name);

    opacity = opacity
      ? Math.floor((Number(opacity.slice(1)) / 100) * 255).toString(16).padStart(2, 0)
      : '';

    return `${colors[name2]}${opacity}`;
  }
}
...
let builders = [
  ...
  [/^(w|h)-([\d\.]+|[\d/]+|\w+|\[[^\]]+\])$/, (x, y) => ({
    [{ w: 'width', h: 'height' }[x]]: y.startsWith('[') ? y.slice(1, -1).replace(/_/g, ' ') : {
      '0.5': '0.125rem', 1: '0.25rem', '1.5': '0.375rem', 2: '0.5rem', '2.5': '0.625rem',
      3: '0.75rem', 4: '1rem', 5: '1.25rem', 6: '1.5rem', 7: '1.75rem', 8: '2rem',
      9: '2.25rem', 10: '2.5rem', 11: '2.75rem', 12: '3rem', 14: '3.5rem', 16: '4rem',
      20: '5rem', 24: '6rem', 28: '7rem', 32: '8rem', 36: '9rem', 40: '10rem',
  ...
  [/^min-(w|h)-(.+)$/, (x, y) => ({
    [{ w: 'min-width', h: 'min-height' }[x]]: y.startsWith('[') ? y.slice(1, -1).replace(/_/g, ' ') : {
      0: 0, '0.5': '0.125rem', 1: '0.25rem', '1.5': '0.375rem', 2: '0.5rem', '2.5': '0.625rem',
      3: '0.75rem', 4: '1rem', 5: '1.25rem', 6: '1.5rem', 7: '1.75rem', 8: '2rem',
      9: '2.25rem', 10: '2.5rem', 11: '2.75rem', 12: '3rem', 14: '3.5rem', 16: '4rem',
      20: '5rem', 24: '6rem', 28: '7rem', 32: '8rem', 36: '9rem', 40: '10rem',
  ...
  [/^max-w-(.+)$/, x => ({
    'max-width': x.startsWith('[') ? x.slice(1, -1).replace(/_/g, ' ') : {
      0: 0, '0.5': '0.125rem', 1: '0.25rem', '1.5': '0.375rem', 2: '0.5rem', '2.5': '0.625rem',
      3: '0.75rem', 4: '1rem', 5: '1.25rem', 6: '1.5rem', 7: '1.75rem', 8: '2rem',
      9: '2.25rem', 10: '2.5rem', 11: '2.75rem', 12: '3rem', 14: '3.5rem', 16: '4rem',
      20: '5rem', 24: '6rem', 28: '7rem', 32: '8rem', 36: '9rem', 40: '10rem',
  ...
  [/^(sans|serif|mono|sntregular)$/, x => ({ 'font-family': { sans: 'sans-serif', mono: 'monospace' }[x] || x })],
